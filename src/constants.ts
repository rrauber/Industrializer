...
export const BUILDINGS: Record<string, BuildingType> = {
  ...
  workshop: {
    ...
    cost: { wood: 20 },
    inputs: { wood: 0.5, stone: 0.25, population: 0.1 }, // Rebalanced: 1 Wood Camp (0.5) supports this.
    catalysts: {},
    outputs: { tools: 0.2 },
    labor: 0,
    unlockEra: 1,
  ...
  surface_mine: {
    ...
    catalysts: { tools: 0.1 }, // Can work without tools, but faster with
  ...
  iron_mine: {
    ...
    inputs: { population: 1.0 },
    catalysts: { tools: 0.5 }, // Significant tool usage
    outputs: { iron_ore: 4 },
    labor: 0,
    requiresTerrain: ['mountain'],
    unlockEra: 2,
  ...
  smelter: {
    ...
    inputs: { iron_ore: 2, coal: 1, population: 0.5 }, // Mandatory
    catalysts: {},
  ...
  tool_factory: {
    ...
    inputs: { iron_ingot: 1, wood: 1, population: 0.5 },
    catalysts: { coal: 0.5 }, // Steam power bonus?
    outputs: { tools: 3 },
    labor: 0,
    unlockEra: 2,
  },
  ...
  steel_mill: {
    ...
    inputs: { iron_ingot: 3, coal: 3, population: 1.0 },
    catalysts: { tools: 0.5 },
    outputs: { steel: 2 },
    labor: 0,
    unlockEra: 3,
  ...
  town: {
    ...
    inputs: { food: 5 },
    catalysts: { tools: 0.1 }, // Tools help maintenance
  ...
  city: {
    ...
    inputs: { food: 15 },
    catalysts: { tools: 0.5, coal: 0.5 }, // Needs heating and tools
